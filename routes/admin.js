...
const PUBLIC_SETTINGS = ['companyName', 'logoPath', 'vantaEffect', 'vantaColor1', 'vantaColor2', 'vantaBgColor', 'vantaSpeed'];
...
router.post('/settings', requireAuth, (req, res) => {
  const allowed = ['companyName', 'vantaEffect', 'vantaColor1', 'vantaColor2', 'vantaBgColor', 'vantaSpeed'];
